 ...
 */
final class Version20241126125733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE adresse (id INT AUTO_INCREMENT NOT NULL, fournisseur_id INT NOT NULL, client_id INT NOT NULL, adresse_libelle VARCHAR(255) NOT NULL, adresse_ville VARCHAR(255) NOT NULL, adresse_postal SMALLINT NOT NULL, adresse_type VARCHAR(255) NOT NULL, adresse_telephone VARCHAR(255) NOT NULL, INDEX IDX_C35F0816670C757F (fournisseur_id), INDEX IDX_C35F081619EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE detail_livraison (id INT AUTO_INCREMENT NOT NULL, livraison_id INT NOT NULL, quantite NUMERIC(15, 2) NOT NULL, INDEX IDX_B7FB4AAA8E54FB25 (livraison_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, role_id INT NOT NULL, utilisateur_prenom VARCHAR(255) NOT NULL, utilisateur_nom VARCHAR(255) NOT NULL, utilisateur_siret VARCHAR(255) DEFAULT NULL, utilisateur_mail VARCHAR(255) NOT NULL, utilisateur_reference VARCHAR(255) NOT NULL, utilisateur_mdp VARCHAR(255) NOT NULL, utilisateur_telephone VARCHAR(255) NOT NULL, utilisateur_verifie TINYINT(1) NOT NULL, utilisateur_coef VARCHAR(255) NOT NULL, utilisateur_derniere_co DATETIME NOT NULL, UNIQUE INDEX UNIQ_1D1C63B3D60322AC (role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE adresse ADD CONSTRAINT FK_C35F081619EB6921 FOREIGN KEY (client_id) REFERENCES utilisateur (id)');
