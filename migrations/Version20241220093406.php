 ...
 */
final class Version20241220093406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, utilisateur_prenom VARCHAR(255) NOT NULL, utilisateur_nom VARCHAR(255) NOT NULL, utilisateur_siret VARCHAR(255) DEFAULT NULL, utilisateur_mail VARCHAR(255) NOT NULL, utilisateur_reference VARCHAR(255) NOT NULL, utilisateur_mdp VARCHAR(255) NOT NULL, utilisateur_telephone VARCHAR(255) NOT NULL, utilisateur_coef VARCHAR(255) NOT NULL, utilisateur_derniere_co DATETIME NOT NULL, verification TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
