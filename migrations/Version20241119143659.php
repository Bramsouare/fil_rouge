 ...
 */
final class Version20241119143659 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE appartient_produit (appartient_id INT NOT NULL, produit_id INT NOT NULL, INDEX IDX_900F2BADD35BF833 (appartient_id), INDEX IDX_900F2BADF347EFB (produit_id), PRIMARY KEY(appartient_id, produit_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE genere_livraison (genere_id INT NOT NULL, livraison_id INT NOT NULL, INDEX IDX_ECC8054ED35A57F1 (genere_id), INDEX IDX_ECC8054E8E54FB25 (livraison_id), PRIMARY KEY(genere_id, livraison_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE livraison_produit (livraison_id INT NOT NULL, produit_id INT NOT NULL, INDEX IDX_695382458E54FB25 (livraison_id), INDEX IDX_69538245F347EFB (produit_id), PRIMARY KEY(livraison_id, produit_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE appartient_produit ADD CONSTRAINT FK_900F2BADD35BF833 FOREIGN KEY (appartient_id) REFERENCES appartient (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE appartient_produit ADD CONSTRAINT FK_900F2BADF347EFB FOREIGN KEY (produit_id) REFERENCES produit (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE genere_livraison ADD CONSTRAINT FK_ECC8054ED35A57F1 FOREIGN KEY (genere_id) REFERENCES genere (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE genere_livraison ADD CONSTRAINT FK_ECC8054E8E54FB25 FOREIGN KEY (livraison_id) REFERENCES livraison (id) ON DELETE CASCADE');
        ...
        $this->addSql('DROP INDEX Id_produit ON appartient');
        $this->addSql('DROP INDEX IDX_4201BAA7B8ADC53F ON appartient');
        $this->addSql('ALTER TABLE appartient ADD id INT AUTO_INCREMENT NOT NULL, DROP Id_commande, DROP Id_produit, CHANGE quantite quantite NUMERIC(15, 2) NOT NULL, CHANGE prix_de_vente prix_de_vente NUMERIC(19, 4) NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
        ...
        $this->addSql('ALTER TABLE genere ADD id INT AUTO_INCREMENT NOT NULL, DROP Id_produit, DROP Id_livraison, CHANGE quantite quantite NUMERIC(15, 2) NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appartient_produit DROP FOREIGN KEY FK_900F2BADD35BF833');
        $this->addSql('ALTER TABLE appartient_produit DROP FOREIGN KEY FK_900F2BADF347EFB');
        ...
        $this->addSql('ALTER TABLE genere_livraison DROP FOREIGN KEY FK_ECC8054ED35A57F1');
        $this->addSql('ALTER TABLE genere_livraison DROP FOREIGN KEY FK_ECC8054E8E54FB25');
        ...
        $this->addSql('ALTER TABLE appartient MODIFY id INT NOT NULL');
        $this->addSql('DROP INDEX `PRIMARY` ON appartient');
        $this->addSql('ALTER TABLE appartient ADD Id_commande INT NOT NULL, ADD Id_produit INT NOT NULL, DROP id, CHANGE quantite quantite NUMERIC(15, 2) DEFAULT NULL, CHANGE prix_de_vente prix_de_vente NUMERIC(19, 4) DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX Id_produit ON appartient (Id_produit)');
        $this->addSql('CREATE INDEX IDX_4201BAA7B8ADC53F ON appartient (Id_commande)');
        $this->addSql('ALTER TABLE appartient ADD PRIMARY KEY (Id_commande, Id_produit)');
        ...
        $this->addSql('ALTER TABLE genere ADD Id_produit INT NOT NULL, ADD Id_livraison INT NOT NULL, DROP id, CHANGE quantite quantite INT DEFAULT NULL');
